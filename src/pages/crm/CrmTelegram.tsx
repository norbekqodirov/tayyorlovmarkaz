...
import {
    ...
    Smartphone, QrCode, Zap, ChevronRight, Shield, Info,
    ArrowRight, Check,
} from 'lucide-react';
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
                        ...
                        <div className="mt-4 p-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 flex items-start gap-2">
                            ...
                            <p className="text-xs text-blue-700 dark:text-blue-300">
                                ...
                                Ota-onalar uchun ham xuddi shunday ishlaydi.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl">
                                ...
                                <p className="text-xs text-amber-700 dark:text-amber-300">
                                    Bu xabar faqat Telegram Chat ID qo'shilgan kishilarga yuboriladi.
                                </p>
                            </div>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    ...
                    <div className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl p-6 text-white overflow-hidden relative">
                        ...
                        <div className="relative">
                            ...
                            <p className="text-sm text-blue-100 leading-relaxed">
                                O'quvchilar va ota-onalar Telegram ichida to'g'ridan portalni ochib, davomat,
                                to'lovlar va baho ma'lumotlarini ko'rishi mumkin.
                            </p>
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
                        ...
                        <p className="text-xs text-zinc-500 mb-4">
                            ...
                            Masalan: <code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">https://sizningsayt.uz/portal</code>
                        </p>
                        <div className="space-y-3">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    placeholder="https://sizningsayt.uz/portal"
                            ...
                            <button
                                onClick={saveMiniApp}
                                disabled={savingMiniApp || !miniAppUrl.trim()}
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                { step: 4, title: "O'quvchilar ulashsin", desc: "O'quvchilar botga /start yuboring va telefon raqamini ulashsin - avtomatik bog'lanadi" },
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-emerald-700 dark:text-emerald-300 mt-1">
                                    Bot yoqilganida o'quvchi yoki ota-ona /start bosib telefon raqamini ulashsa,
                                    tizim avtomatik ularning profiliga Telegram ID ni bog'laydi.
                                    Chat ID qo'lda kiritish shart emas!
                                </p>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
                        <h3 className="font-bold text-slate-900 dark:text-white mb-5 flex items-center gap-2">
                            <Shield size={16} className="text-blue-500" /> Bot Sozlamalari
                        </h3>
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1.5">
                                    ...
                                    {settings?.botTokenSet && (
                                        <span className="ml-2 text-emerald-500 normal-case font-normal">✓ o'rnatilgan</span>
                                    )}
                                </label>
                                <div className="relative">
                                    <input
                            ...
                            <div className="space-y-2 pt-1">
                                ...
                                {[
                                    { key: 'autoAttendance', label: 'Davomat: kelmagan kun ota-onaga xabar', emoji: '📚', value: autoAttendance, setter: setAutoAttendance },
                                    { key: 'autoPayment', label: "To'lov: muddati o'tganda eslatma", emoji: '💰', value: autoPayment, setter: setAutoPayment },
                                    { key: 'autoLead', label: 'Lid: yangi lid kelganda admin alert', emoji: '🎯', value: autoLead, setter: setAutoLead },
                                ].map(item => (
                                    <label key={item.key} className="flex items-center gap-3 p-3 bg-zinc-50 dark:bg-zinc-800 rounded-xl cursor-pointer">
                                        ...
                                        >
                                            <span className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${item.value ? 'translate-x-5.5' : 'translate-x-0.5'}`} />
                                        </button>
                    ...
                    <div className="bg-zinc-50 dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 p-4">
                        ...
                        <p className="text-xs text-zinc-400 mt-2">BotFather → @{botStatus?.username || 'botingiz'} → Edit Bot → Edit Commands</p>
                    </div>
                </motion.div>
            )}
                            ...
                            <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
                                {history.map(msg => (
                                    <div key={msg.id} className="flex items-start gap-3 p-4">
                                        <div className={`w-7 h-7 rounded-lg flex-shrink-0 flex items-center justify-center text-xs font-bold ${msg.status === 'sent' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : 'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400'}`}>
                                            {msg.status === 'sent' ? '✓' : '✗'}
                                        </div>
                                        <div className="flex-1 min-w-0">
                        ...
                        {historyTotal > 20 && (
                            <div className="p-4 flex items-center justify-between border-t border-zinc-100 dark:border-zinc-800">
                                <button
                                    ...
                                    className="px-3 py-1.5 text-sm rounded-lg bg-zinc-100 dark:bg-zinc-800 disabled:opacity-40 font-bold"
                                >← Oldingi</button>
