  ...
  return (
    <div className="space-y-6">
      ...
      {/* MUHIM: mode="wait" ISHLATILMAYDI — bu holatda AnimatePresence chiquvchi
          ...
          almashtirish butunlay bloklanib qoladi (ROI/AVTOMATIZATSIYA umuman
          ochilmaydi edi — real brauzer klikida ham tasdiqlangan bug). Default
          (sync) rejimda yangi tarkib darhol ko'rinadi, eskisi orqa fonda mustaqil
