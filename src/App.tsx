...
const CrmPositions  = React.lazy(() => import('./pages/crm/hr/CrmPositions'));
        ...
        <Suspense fallback={<GlobalSpinner />}>
          <Routes>
            ...
            >
              ...
              <Route path="positions"        element={<ProtectedRoute allowedRoles={['ADMIN']}><CrmPositions /></ProtectedRoute>} />
